// Generated comprehensive tests for src\testing\load-tester-worker.js
const path = require('path');

describe('load-tester-worker - Generated Tests', () => {
  let module;
  ...
  beforeAll(() => {
    try {
      ...
      module = require('../../../../src/testing/load-tester-worker.js');
    } catch (error) {
