...
const openVoiceController = require('../controllers/open-voice.controller');
const { authenticateToken, authenticateApiKey, hasPermission } = require('../auth/auth.middleware');
