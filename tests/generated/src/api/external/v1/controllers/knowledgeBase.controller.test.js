// Generated comprehensive tests for src\api\external\v1\controllers\knowledgeBase.controller.js
const path = require('path');

describe('knowledgeBase.controller - Generated Tests', () => {
  let module;
  ...
  beforeAll(() => {
    try {
      ...
      module = require('../../../../../../../src/api/external/v1/controllers/knowledgeBase.controller.js');
    } catch (error) {
